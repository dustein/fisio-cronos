      ...
      <div className="space-y-4">
        ...
        <div className="bg-green-900/30 rounded-lg p-3">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-16 px-2 py-1 bg-gray-800 text-white rounded text-center"
              placeholder="0"
            />
            ...
            <div className="text-green-400 font-mono ml-2">
        ...
        <div className="bg-blue-900/30 rounded-lg p-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <span className="text-white text-sm">seg</span>
            <div className="text-blue-400 font-mono ml-2">
        ...
        <div className="bg-yellow-900/30 rounded-lg p-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="text-yellow-400 font-mono ml-2">
              = {totalMin} min
            </div>
          </div>
        </div>
